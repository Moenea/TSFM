...
echo "============================================"
echo "4/5  Fine-tuned U"
echo "============================================"
python -u run.py $COMMON \
  --model_id PCA101A_U_full_shot \
  --features S \
  --test_dir forecast_PCA101A_U_full_shot_timer_xl_MultivariateDatasetYAMLSplit_sl1536_it96_ot96_lr5e-06_bt32_wd0_el8_dm1024_dff2048_nh8_cosTrue_test_0

echo "============================================"
echo "5/5  Fine-tuned Co"
echo "============================================"
python -u run.py $COMMON \
  --model_id PCA101A_Co_full_shot \
  --features MS \
  --covariate \
  --test_dir forecast_PCA101A_Co_full_shot_timer_xl_MultivariateDatasetYAMLSplit_sl1536_it96_ot96_lr5e-06_bt32_wd0_el8_dm1024_dff2048_nh8_cosTrue_test_0
